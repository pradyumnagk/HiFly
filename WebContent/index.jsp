      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
           <%
           ArrayList<FlightDisplay> result = (ArrayList<FlightDisplay>) request.getAttribute("displayList");
	%>

        <input  placeholder="Source" required autofocus>
        <input  placeholder="Destination" required autofocus>
